...
const TestResult = () => {
  ...
  <div className="text-center mb-6">
    <h2 className="text-xl font-semibold text-gray-700">
      Điểm: <span className="text-blue-600">{score.toFixed(2)}/10</span>
    </h2>
          ...
          return (
            <li
              ...
              className={`p-2 rounded-md transition-all ${
                isCorrectSelection ? "bg-green-100 text-green-700 font-semibold" :
                isSelected ? "bg-red-100 text-red-700 font-semibold" :
                isCorrectAnswer ? "border border-green-500 text-green-700" : "text-gray-700"
              }`}
            >
              {key}. {value} {isCorrectSelection ? "✅" : isSelected ? "❌" : ""}
            </li>
          );
        })}
      </ul>
